...
def loadGrub():
    ...
    try:
        ...
        #f = open('/boot/efi/EFI/ubuntu/grub.cfg', 'r')
    except IOError:
...
def setEntry(path):
    ...
    while True:
        answer = input(bcolors.BOLD + \
                ...
                bcolors.ENDC )
        if answer=="y" or answer=="Y" or answer=="yes" or answer=="":
            # print cmd in green and cmd in default color
            print(bcolors.OKGREEN + cmd + bcolors.ENDC, os.system(cmd))
            reboot()
